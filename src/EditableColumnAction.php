...
class EditableColumnAction extends Action
{
    ...
    {
        $this->errorMessages += [
            'invalidEditable' => Yii::t('vkgrid', 'Invalid or bad editable data'),
            'invalidModel' => Yii::t('vkgrid', 'No valid editable model found'),
            'editableException' => Yii::t('vkgrid', 'Invalid editable index or model form name'),
            'saveException' => Yii::t('vkgrid', 'Failed to update editable data due to an unknown server error'),
        ];
    }
