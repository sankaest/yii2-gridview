...
class ExpandRowColumn extends DataColumn
{
    ...
    public function init()
    {
        ...
        if (!isset($this->msgDetailLoading)) {
            $this->msgDetailLoading = Yii::t('vkgrid', '<small>Loading &hellip;</small>');
        }
        ...
        $this->setProp('expandTitle', Yii::t('vkgrid', 'Expand'));
        $this->setProp('collapseTitle', Yii::t('vkgrid', 'Collapse'));
        $this->setProp('expandAllTitle', Yii::t('vkgrid', 'Expand All'));
        $this->setProp('collapseAllTitle', Yii::t('vkgrid', 'Collapse All'));
