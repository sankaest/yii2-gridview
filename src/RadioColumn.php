...
class RadioColumn extends Column
{
     ...
     */
    public $rowSelectedClass = GridView::BS_TABLE_SUCCESS;

    /**
     * @var string highlight CSS class to be applied for highlighting the row. Defaults to 'success'.
     */
    public $radioSelectionClearClass = 'grid-radio-clear';
    ...
    public function init()
    {
        ...
        $this->grid->radioSelectionExist = true;
        $this->grid->radioSelectionName = $this->name;
        $this->grid->radioSelectedRowClass = $this->rowSelectedClass;
        $this->grid->radioSelectionClearClass = $this->radioSelectionClearClass;
    ...
    protected function renderHeaderCellContent()
    {
        if ($this->header !== null || !$this->showClear) {
            ...
            Html::addCssClass($this->clearOptions, $this->radioSelectionClearClass);

            if (empty($this->clearOptions['title'])) {
                $this->clearOptions['title'] = Yii::t('vkgrid', 'Clear selection');
            }
