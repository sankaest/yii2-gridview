...
class ExportController extends Controller
{
    ...
    public function actionDownload()
    {
        ...
        $name = $request->post('export_filename', Yii::t('vkgrid', 'export'));
        $content = $request->post('export_content', Yii::t('vkgrid', 'No data found'));
    ...
    protected function generatePDF($content, $filename, $config = [])
    {
        ...
        $config['methods']['SetAuthor'] = [Yii::t('vkgrid', 'Krajee Solutions')];
        $config['methods']['SetCreator'] = [Yii::t('vkgrid', 'Krajee Yii2 Grid Export Extension')];
