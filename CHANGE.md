...
- (enh #106): Back and forward browser bug for PJAX.
    - New property `pjaxDuplicationFix` available in widgets/extensions that use `sankaest\rebase\WidgetTrait`
